...
try:
    ...
    class obs:
        ...
        OBS_FRONTEND_EVENT_VIRTUALCAM_STOPPED = None
        OBS_FRONTEND_EVENT_VIRTUALCAM_STARTED = None
        OBS_FRONTEND_EVENT_SCRIPTING_SHUTDOWN = None
        OBS_FRONTEND_EVENT_FINISHED_LOADING = 0
        OBS_FRONTEND_EVENT_EXIT = 1
        OBS_FRONTEND_EVENT_STUDIO_MODE_DISABLED = None
        OBS_FRONTEND_EVENT_STUDIO_MODE_ENABLED = None
        OBS_FRONTEND_EVENT_SCENE_COLLECTION_CLEANUP = None
        OBS_FRONTEND_EVENT_SCENE_COLLECTION_RENAMED = None
        OBS_FRONTEND_EVENT_SCENE_COLLECTION_LIST_CHANGED = None
        OBS_FRONTEND_EVENT_SCENE_COLLECTION_CHANGED = None
        OBS_FRONTEND_EVENT_SCENE_COLLECTION_CHANGING = None
        ...
        OBS_FRONTEND_EVENT_TRANSITION_DURATION_CHANGED = None
        OBS_FRONTEND_EVENT_TRANSITION_LIST_CHANGED = None
        OBS_FRONTEND_EVENT_TRANSITION_STOPPED = None
        OBS_FRONTEND_EVENT_TRANSITION_CHANGED = None
        OBS_FRONTEND_EVENT_SCENE_LIST_CHANGED = None
        OBS_FRONTEND_EVENT_PREVIEW_SCENE_CHANGED = 27
        OBS_FRONTEND_EVENT_SCENE_CHANGED = None
        OBS_FRONTEND_EVENT_REPLAY_BUFFER_SAVED = None
        OBS_FRONTEND_EVENT_REPLAY_BUFFER_STOPPED = None
        OBS_FRONTEND_EVENT_REPLAY_BUFFER_STOPPING = None
        OBS_FRONTEND_EVENT_REPLAY_BUFFER_STARTED = None
        OBS_FRONTEND_EVENT_REPLAY_BUFFER_STARTING = None
        OBS_FRONTEND_EVENT_RECORDING_UNPAUSED = None
        OBS_FRONTEND_EVENT_RECORDING_PAUSED = None
        OBS_FRONTEND_EVENT_RECORDING_STOPPED = None
        OBS_FRONTEND_EVENT_RECORDING_STOPPING = None
...
def log_save(log_level: Literal["INFO", "DEBUG", "WARNING", "ERROR"], log_str: str, print_is: bool = True) -> None:
    """
    输出并保存日志
    Args:
        print_is: 是否输出
    ...
    log_type = {
        "INFO": obs.LOG_INFO,
        "DEBUG": obs.LOG_DEBUG,
        "WARNING": obs.LOG_WARNING,
        "ERROR": obs.LOG_ERROR,
    }
    now = datetime.now()
    formatted = now.strftime("%Y/%m/%d %H:%M:%S")
    _log_text = f"【{formatted}】 【{log_level}】 {log_str}"
    if print_is:
        obs.script_log(log_type[log_level], _log_text)
    GlobalVariableOfData.log_text += _log_text + "\n"
...
class Widget:
    ...
    def preliminary_configuration_control(self):
        ...
        for basic_types_controls in self.widget_dict_all:
            log_save("INFO", f"{basic_types_controls}")
