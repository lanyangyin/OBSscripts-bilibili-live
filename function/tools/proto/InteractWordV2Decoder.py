...
if __name__ == "__main__":
    base64_str = "CN+GjCASDOaciOacl+mjjui9uyIBASgBMMv6FziZgeDGBkCfr4nemDNiAHjIqMrn3pnLtBiaAQCyAWYI34aMIBJZCgzmnIjmnJfpo47ovbsSSWh0dHA6Ly9pMC5oZHNsYi5jb20vYmZzL2ZhY2UvMzU2MmY2MjdhNmMwMDE2NmE1ZGVhYTdjZDUxNjA0MDljMDk1N2Y5NS5qcGciAggCMgC6AQDCAQA="

    print("\n=== 完整解析 ===")
    result2 = InteractWordV2Decoder().decode_with_protobuf(base64_str)
    if result2:
