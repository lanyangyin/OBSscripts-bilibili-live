import base64
import json
from function.tools.str_to_module import str_to_module

class OnlineRankV3Decoder:
    def __init__(self):
...
"""
    ...
    def decode_with_protobuf(self, base64_string):
        """
