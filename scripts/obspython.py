...
def obs_properties_add_button(danmu_props, param, param1, send):
    return None
...
def obs_properties_add_button(live_props, param, param1, start_area1):
    return None


def obs_properties_add_button(setting_props, param, param1, login):
    return None
...
def timer_add(check_poll, param):
    return None